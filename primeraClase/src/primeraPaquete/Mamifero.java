...
{public Mamifero(boolean sexo_masculino, int peso, double altura, String fecha_nacimiento, String especie,
	...
	Mamifero(Mamifero _mp) {
		peso=_mp.getPeso();
		altura=_mp.getAltura();
		fecha_nacimiento=_mp.getFecha_nacimiento();
		especie=_mp.getEspecie();
		sexo_masculino=_mp.isSexo_masculino();
